...
This chapter explains the tool selection, testing methodology, and evaluation
design used to deliver GiTrip. The project followed an iterative waterfall
approach: fixed milestones aligned to university deadlines provided structure,
while work within each milestone was refined through short feedback cycles and
regular supervisor meetings. The full development process and schedule are discussed in the Project Management Report.
...
read/write operations). Express provides a minimal server and API layer since Embedded JavaScript (EJS) supports rapid iteration on key User Experience (UX)
...
This design intentionally combines objective evidence (task completion and time) with subjective user perception (usability and perceived value), aligning with a pragmatic interpretation of TAM in small-sample contexts.
