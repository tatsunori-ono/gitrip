...
supporting features. Each section explains not only what was built but why that approach was chosen over alternatives.
...
This set is intentionally constrained to keep the UI manageable for non-experts while preventing silent data loss. Figure~\ref{fig:ui-merge} shows the merge conflict resolution page: per-stop version picker
