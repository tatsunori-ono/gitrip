...
\begin{figure}[H]
  ...
  \begin{tikzpicture}[
    ...
    \node[process] (nn) at (4,-5.8) {Held-Karp ($N\!\leq\!12$)\\or NN + 2-opt ($N\!>\!12$)};
  ...
  \caption{Auto-scheduler flowchart. The algorithm builds an ORS
           ...
           (strict constraints, Held-Karp for $N \leq 12$, or NN + 2-opt),
           then partitions
...
The page renders an SVG day timeline (08:00--21:00) with animated stop blocks,
