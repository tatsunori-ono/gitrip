...
step increments), text-based route editing as a fallback, and stronger ARIA
...
A natural extension is to explore Conflict-free Replicated Data Type (CRDT)
based shared plan editing, enabling multiple users to edit the same itinerary
...
ferries and flights as route legs, integration of GTFS-based transit data where
applicable, and improved offline routing approximations for areas with limited
API coverage.

\paragraph{Optional ML/AI extensions.}
AI-powered features were deliberately excluded from the MVP to preserve
